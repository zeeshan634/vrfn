...
<div class="logo">
	...
	<img src="<?php echo base_url(); ?>assets/images/logo.png" style="width: 300px;" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url(); ?>admin/login/update_password_code" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="c-password" required=""/>
		</div>
		<div class="form-actions">
            <input type="hidden" name="pass_code" value="<?php echo $pass_code; ?>">
			<button type="submit" class="btn btn-success uppercase">Rest password</button>		
