				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Extra Payment History
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<tr id="company_<?php echo $row->ID; ?>" class="odd gradeX">
								...
								<td><?php echo $row->StripeCustomerID; ?></td>
								
								<td><?php echo $row->StripeTxID; ?></td>
								
								<td><?php echo date("d-m-Y", $row->createdAt); ?></td>
