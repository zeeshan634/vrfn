...
?>
	...
	<div class="page-content-wrapper">
		<div class="page-content">		
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<?php echo $user_data[0]['admin_name']; ?> Profile <small> Setting</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href=""><?php echo $user_data[0]['admin_name']; ?> profile</a>
				...
				<div class="col-md-offset-2 col-md-8">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form"> 
							<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/profile/update_code" role="form">
                            <?php if($this->session->flashdata('success')){ ?>
								...
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" name="admin_name" value="<?php echo $user_data[0]['admin_name']; ?>" required="">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="input-group">
												...
												<input type="email" class="form-control" name="admin_email" value="<?php echo $user_data[0]['admin_email']; ?>" >
											</div>
										</div>
									</div>	
								</div>
	  		...
	  		<div class="row">	
				<div class="col-md-offset-2 col-md-8">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form"> 
							<form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>admin/profile/change_password">
