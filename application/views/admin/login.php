...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url(); ?>admin/login/login_access" method="post">
	...
	<form class="forget-form" id="forget_pass_form" action="<?php echo base_url();?>admin/login/forgot" method="post">
		...
		<div class="form-actions">
			...
			<button style="display: none" type="button" onclick="forget_passdd()" class="btn btn-success uppercase pull-right">Submit</button>
		</div>
	</form>
